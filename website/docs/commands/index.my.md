...
* `dfir-timeline`: timeline ကို CSV/JSON/JSONL ဖော်မတ်ဖြင့် သိမ်းဆည်းပါ။
...
* `update-rules`: [hayabusa-rules](https://github.com/Yamato-Security/hayabusa-rules) GitHub repository ရှိ နောက်ဆုံးပေါ် rules များသို့ rules များကို ထပ်တူပြုပါ။
