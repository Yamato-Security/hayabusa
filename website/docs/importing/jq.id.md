...
Pada versi Hayabusa saat ini, Anda dapat menyimpan hasil dalam JSON dengan `hayabusa dfir-timeline -t json -d <directory> -o results.json` atau `hayabusa dfir-timeline -t jsonl -d <directory> -o results.jsonl` untuk format JSONL.
