...
Na versão atual do Hayabusa, você pode salvar os resultados em JSON com `hayabusa dfir-timeline -t json -d <directory> -o results.json` ou `hayabusa dfir-timeline -t jsonl -d <directory> -o results.jsonl` para o formato JSONL.
