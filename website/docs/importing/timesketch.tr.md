...
> CSV dosyaniz yuklenemeyecek kadar buyukse, dosyayi Takajo'nun [split-dfir-timeline](https://github.com/Yamato-Security/takajo?tab=readme-ov-file#split-dfir-timeline-command) komutuyla birden fazla CSV dosyasina bolebilirsiniz.
