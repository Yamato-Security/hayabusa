...
In the current version of Hayabusa, you can save the results in JSON with `hayabusa dfir-timeline -t json -d <directory> -o results.json` or `hayabusa dfir-timeline -t jsonl -d <directory> -o results.jsonl` for JSONL format.
