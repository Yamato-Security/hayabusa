...
En la versión actual de Hayabusa, puedes guardar los resultados en JSON con `hayabusa dfir-timeline -t json -d <directory> -o results.json` o `hayabusa dfir-timeline -t jsonl -d <directory> -o results.jsonl` para el formato JSONL.
