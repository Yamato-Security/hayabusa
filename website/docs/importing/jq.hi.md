...
Hayabusa के वर्तमान संस्करण में, आप परिणामों को JSON में `hayabusa dfir-timeline -t json -d <directory> -o results.json` के साथ या JSONL प्रारूप के लिए `hayabusa dfir-timeline -t jsonl -d <directory> -o results.jsonl` के साथ सहेज सकते हैं।
