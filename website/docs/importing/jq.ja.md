...
現在バージョン2.xのHayabusaでは、`hayabusa dfir-timeline -t json -d <directory> -o results.json`でJSON、`hayabusa dfir-timeline -t json -d <directory> -J -o results.jsonl` でJSONLに結果を保存できます。
