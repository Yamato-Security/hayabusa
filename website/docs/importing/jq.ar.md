...
في الإصدار الحالي من Hayabusa، يمكنك حفظ النتائج بصيغة JSON باستخدام `hayabusa dfir-timeline -t json -d <directory> -o results.json` أو `hayabusa dfir-timeline -t jsonl -d <directory> -o results.jsonl` لصيغة JSONL.
