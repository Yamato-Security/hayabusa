...
In der aktuellen Version von Hayabusa können Sie die Ergebnisse in JSON mit `hayabusa dfir-timeline -t json -d <directory> -o results.json` oder `hayabusa dfir-timeline -t jsonl -d <directory> -o results.jsonl` für das JSONL-Format speichern.
