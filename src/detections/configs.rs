...
pub struct DetectCommonOption {
    ...
    #[arg(help_heading = Some("General Options"), long = "target-file-ext", value_name = "FILE-EXT...", use_value_delimiter = true, value_delimiter = ',', display_order = 450, value_hint(ValueHint::FilePath))]
